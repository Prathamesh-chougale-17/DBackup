    ...
    <section className="relative border-y border-border/60 bg-card/40 dark:border-transparent dark:bg-card/20">
      ...
      <div className="mx-auto max-w-6xl px-6 py-20 sm:py-24">
        <SectionHeading
          ...
          description="9 database engines, 14 storage adapters that work as backup destinations, as directory sources, or as both, and 9 notification channels - out of the box."
        />
