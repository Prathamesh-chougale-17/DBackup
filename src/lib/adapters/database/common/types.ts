...
export interface DatabaseEntry {
    ...
    size: number;
    /** Dump format: sql (MySQL), custom (PostgreSQL -Fc), archive (MongoDB), bak (MSSQL), fbk (Firebird gbak), bacpac (Azure SQL Database) */
    format: "sql" | "custom" | "archive" | "bak" | "fbk" | "bacpac";
}
