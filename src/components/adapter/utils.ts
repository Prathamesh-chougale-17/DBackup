...
// - Inline bundled icons (no npm package available; data fetched from Iconify API) -
...
// @iconify-icons/devicon (npm) hasn't republished with newer icons in a while and
// lacks "firebird" - source: devicon:firebird via the Iconify API (MIT licensed).
